# VoiceShift
  ...
  5. Save your settings as a named preset for later
  ...
  All processing runs in the browser audio thread. CPU usage is minimal (< 1% on modern hardware). No audio data is sent to the server — only preset configurations are stored.
